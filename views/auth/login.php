...
<div class="flex justify-center items-center min-h-[60vh]">
    <div class="glass-panel p-8 rounded-2xl w-full max-w-md shadow-lg">
        <h1 class="text-4xl font-bold text-center mb-2 bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Entrar</h1>
        <p class="text-center text-slate-400 mb-8">Acesse sua conta CodeGames</p>
        ...
        <form action="/login" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="password" id="password" name="password" class="w-full bg-black/20 border border-white/10 rounded-md px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/50 transition-all" required>
            </div>
        ...
        <p class="text-center text-sm text-slate-400 mt-8">
            Ainda não tem conta? <a href="/register" class="text-brand-500 hover:text-white transition-colors">Cadastre-se</a>
        </p>
    </div>
</div>
